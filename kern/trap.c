...
trap_init(void)
{
    ...
    extern void irq_19();
        ...
        SETGATE(idt[IRQ_OFFSET+19],0,GD_KT,irq_19,3);
	// Per-CPU setup 
	trap_init_percpu();
}
...
trap_init_percpu(void)
{
    ...
    wrmsr(0x174,0x0,GD_KD);
    wrmsr(0x175,0x0,sysenter_handler);
    wrmsr(0x176,0x0,KSTACKTOP);
         */
}
	...
	// LAB 4: Your code here.
        if(curenv->env_pgfault_upcall){
            ...
            if(tf->tf_esp<UXSTACKTOP&&tf->tf_esp>UXSTACKTOP-PGSIZE){
                ...
                utf = (struct UTrapframe*)(UXSTACKTOP-4-sizeof(struct UTrapframe));
            }
